...
var len__9524__auto___17668 = arguments.length;
var i__9525__auto___17669 = (0);
while(true){
if((i__9525__auto___17669 < len__9524__auto___17668)){
args__9531__auto__.push((arguments[i__9525__auto___17669]));

var G__17670 = (i__9525__auto___17669 + (1));
i__9525__auto___17669 = G__17670;
continue;
} else {
}
break;
...
clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__17656){
var map__17657 = p__17656;
var map__17657__$1 = ((((!((map__17657 == null)))?((((map__17657.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__17657.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__17657):map__17657);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17657__$1,cljs.core.cst$kw$seed);
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__17657__$1,cljs.core.cst$kw$max_DASH_size,(200));
var vec__17659 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17659,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17659,(1),null);
...
var size = first__17664;
var rest_size_seq = seq__17663__$1;
var vec__17665 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17665,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17665,(1),null);
...
var G__17671 = (so_far + (1));
var G__17672 = rest_size_seq;
var G__17673 = r2;
so_far = G__17671;
size_seq__$1 = G__17672;
rstate = G__17673;
continue;
} else {
...
clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq17653){
...
return clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic(G__17654,G__17655,seq17653__$2);
});
...
var head = first__17676;
var tail = seq__17675__$1;
var result = cljs.core.cst$kw$result.cljs$core$IFn$_invoke$arity$1(clojure.test.check.rose_tree.root(head));
if(cljs.core.truth_(clojure.test.check.not_falsey_or_exception_QMARK_(result))){
var G__17677 = tail;
var G__17678 = current_smallest;
var G__17679 = (total_nodes_visited + (1));
var G__17680 = depth;
nodes = G__17677;
current_smallest = G__17678;
total_nodes_visited = G__17679;
depth = G__17680;
continue;
} else {
...
var G__17681 = children;
var G__17682 = clojure.test.check.rose_tree.root(head);
var G__17683 = (total_nodes_visited + (1));
var G__17684 = (depth + (1));
nodes = G__17681;
current_smallest = G__17682;
total_nodes_visited = G__17683;
depth = G__17684;
continue;
} else {
var G__17685 = tail;
var G__17686 = clojure.test.check.rose_tree.root(head);
var G__17687 = (total_nodes_visited + (1));
var G__17688 = depth;
nodes = G__17685;
current_smallest = G__17686;
total_nodes_visited = G__17687;
depth = G__17688;
continue;
}
}
