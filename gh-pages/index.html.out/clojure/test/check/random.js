...
var G__15767 = z;
if(((24) > (function (){var G__15768 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__15768) : clojure.test.check.random.longs.bit_count.call(null,G__15768));
})())){
return clojure.test.check.random.longs.bit_xor(G__15767,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__15767;
}
});
...
var G__15771 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__15772 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__15771;
ret = G__15772;
continue;
}
...
return (function (p__15773){
var map__15774 = p__15773;
var map__15774__$1 = ((((!((map__15774 == null)))?((((map__15774.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15774.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__15774):map__15774);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15774__$1,cljs.core.cst$kw$state);
var vec__15776 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15776,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15776,(1),null);
