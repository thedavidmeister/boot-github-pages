...
var G__16088 = z;
if(((24) > (function (){var G__16089 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__16089) : clojure.test.check.random.longs.bit_count.call(null,G__16089));
})())){
return clojure.test.check.random.longs.bit_xor(G__16088,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__16088;
}
});
...
var G__16092 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__16093 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__16092;
ret = G__16093;
continue;
}
...
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16095__$1,cljs.core.cst$kw$state);
var vec__16097 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16097,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16097,(1),null);
