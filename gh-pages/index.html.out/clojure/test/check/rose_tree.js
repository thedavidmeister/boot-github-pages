...
clojure.test.check.rose_tree.RoseTree.cljs$lang$ctorPrWriter = (function (this__9316__auto__,writer__9317__auto__,opt__9318__auto__){
return cljs.core._write(writer__9317__auto__,"clojure.test.check.rose-tree/RoseTree");
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__16269 = (n - (1));
var G__16270 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__16269,G__16270) : clojure.test.check.rose_tree.exclude_nth.call(null,G__16269,G__16270));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__16272 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__16272) : f.call(null,G__16272));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__16271_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__16271_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__16271_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__16273_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__16273_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__16273_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__16274_SHARP_){
var G__16275 = clojure.test.check.rose_tree.root(p1__16274_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__16275) : pred.call(null,G__16275));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__9527__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__16276(s__16277){
return (new cljs.core.LazySeq(null,(function (){
var s__16277__$1 = s__16277;
while(true){
var temp__5290__auto__ = cljs.core.seq(s__16277__$1);
if(temp__5290__auto__){
var xs__5843__auto__ = temp__5290__auto__;
var vec__16282 = cljs.core.first(xs__5843__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16282,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16282,(1),null);
var iterys__9523__auto__ = ((function (s__16277__$1,vec__16282,rose,index,xs__5843__auto__,temp__5290__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__16276_$_iter__16278(s__16279){
return (new cljs.core.LazySeq(null,((function (s__16277__$1,vec__16282,rose,index,xs__5843__auto__,temp__5290__auto__){
return (function (){
var s__16279__$1 = s__16279;
while(true){
var temp__5290__auto____$1 = cljs.core.seq(s__16279__$1);
if(temp__5290__auto____$1){
var s__16279__$2 = temp__5290__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__16279__$2)){
var c__9525__auto__ = cljs.core.chunk_first(s__16279__$2);
var size__9526__auto__ = cljs.core.count(c__9525__auto__);
var b__16281 = cljs.core.chunk_buffer(size__9526__auto__);
if((function (){var i__16280 = (0);
while(true){
if((i__16280 < size__9526__auto__)){
var child = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__9525__auto__,i__16280);
cljs.core.chunk_append(b__16281,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__16285 = (i__16280 + (1));
i__16280 = G__16285;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__16281),clojure$test$check$rose_tree$permutations_$_iter__16276_$_iter__16278(cljs.core.chunk_rest(s__16279__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__16281),null);
}
} else {
var child = cljs.core.first(s__16279__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__16276_$_iter__16278(cljs.core.rest(s__16279__$2)));
}
} else {
return null;
}
...
});})(s__16277__$1,vec__16282,rose,index,xs__5843__auto__,temp__5290__auto__))
,null,null));
});})(s__16277__$1,vec__16282,rose,index,xs__5843__auto__,temp__5290__auto__))
;
var fs__9524__auto__ = cljs.core.seq(iterys__9523__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__9524__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__9524__auto__,clojure$test$check$rose_tree$permutations_$_iter__16276(cljs.core.rest(s__16277__$1)));
} else {
var G__16286 = cljs.core.rest(s__16277__$1);
s__16277__$1 = G__16286;
continue;
}
} else {
return null;
...
return iter__9527__auto__(cljs.core.map.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,roses,cljs.core.range.cljs$core$IFn$_invoke$arity$0()));
});
/**
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__16287_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__16287_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__16287_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__16288_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__16288_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__16288_SHARP_));
