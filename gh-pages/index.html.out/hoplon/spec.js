...
hoplon.spec.do_BANG_ = (function (){var method_table__9698__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
...
var hierarchy__9702__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$default,cljs.core.cst$kw$hoplon$spec_SLASH_default], null),cljs.core.cst$kw$hierarchy,cljs.core.get_global_hierarchy());
return (new cljs.core.MultiFn(cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("hoplon.spec","do!"),((function (method_table__9698__auto__,prefer_table__9699__auto__,method_cache__9700__auto__,cached_hierarchy__9701__auto__,hierarchy__9702__auto__){
return (function (p__15460){
var vec__15461 = p__15460;
var elem = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15461,(0),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15461,(1),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15461,(2),null);
...
,cljs.core.cst$kw$hoplon$spec_SLASH_default,hierarchy__9702__auto__,method_table__9698__auto__,prefer_table__9699__auto__,method_cache__9700__auto__,cached_hierarchy__9701__auto__));
})();
}
...
hoplon.spec.on_BANG_ = (function (){var method_table__9698__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var prefer_table__9699__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var method_cache__9700__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__9701__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__9702__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$default,cljs.core.cst$kw$hoplon$spec_SLASH_default], null),cljs.core.cst$kw$hierarchy,cljs.core.get_global_hierarchy());
return (new cljs.core.MultiFn(cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("hoplon.spec","on!"),((function (method_table__9698__auto__,prefer_table__9699__auto__,method_cache__9700__auto__,cached_hierarchy__9701__auto__,hierarchy__9702__auto__){
return (function (p__15464){
var vec__15465 = p__15464;
var elem = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15465,(0),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15465,(1),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15465,(2),null);
var temp__5288__auto__ = cljs.core.namespace(key);
if(cljs.core.truth_(temp__5288__auto__)){
var n = temp__5288__auto__;
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(n,"*");
