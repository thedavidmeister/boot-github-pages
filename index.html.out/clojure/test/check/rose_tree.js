...
return cljs.core.cons(cljs.core.first(s),(function (){var G__16062 = (n - (1));
var G__16063 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__16062,G__16063) : clojure.test.check.rose_tree.exclude_nth.call(null,G__16062,G__16063));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__16065 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__16065) : f.call(null,G__16065));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__16064_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__16064_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__16064_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__16066_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__16066_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__16066_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__16067_SHARP_){
var G__16068 = clojure.test.check.rose_tree.root(p1__16067_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__16068) : pred.call(null,G__16068));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__9128__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__16069(s__16070){
return (new cljs.core.LazySeq(null,(function (){
var s__16070__$1 = s__16070;
while(true){
var temp__5290__auto__ = cljs.core.seq(s__16070__$1);
if(temp__5290__auto__){
var xs__5843__auto__ = temp__5290__auto__;
var vec__16075 = cljs.core.first(xs__5843__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16075,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16075,(1),null);
var iterys__9124__auto__ = ((function (s__16070__$1,vec__16075,rose,index,xs__5843__auto__,temp__5290__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__16069_$_iter__16071(s__16072){
return (new cljs.core.LazySeq(null,((function (s__16070__$1,vec__16075,rose,index,xs__5843__auto__,temp__5290__auto__){
return (function (){
var s__16072__$1 = s__16072;
while(true){
var temp__5290__auto____$1 = cljs.core.seq(s__16072__$1);
if(temp__5290__auto____$1){
var s__16072__$2 = temp__5290__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__16072__$2)){
var c__9126__auto__ = cljs.core.chunk_first(s__16072__$2);
var size__9127__auto__ = cljs.core.count(c__9126__auto__);
var b__16074 = cljs.core.chunk_buffer(size__9127__auto__);
if((function (){var i__16073 = (0);
while(true){
if((i__16073 < size__9127__auto__)){
var child = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__9126__auto__,i__16073);
cljs.core.chunk_append(b__16074,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__16078 = (i__16073 + (1));
i__16073 = G__16078;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__16074),clojure$test$check$rose_tree$permutations_$_iter__16069_$_iter__16071(cljs.core.chunk_rest(s__16072__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__16074),null);
}
} else {
var child = cljs.core.first(s__16072__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__16069_$_iter__16071(cljs.core.rest(s__16072__$2)));
}
} else {
return null;
}
...
});})(s__16070__$1,vec__16075,rose,index,xs__5843__auto__,temp__5290__auto__))
,null,null));
});})(s__16070__$1,vec__16075,rose,index,xs__5843__auto__,temp__5290__auto__))
;
var fs__9125__auto__ = cljs.core.seq(iterys__9124__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__9125__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__9125__auto__,clojure$test$check$rose_tree$permutations_$_iter__16069(cljs.core.rest(s__16070__$1)));
} else {
var G__16079 = cljs.core.rest(s__16070__$1);
s__16070__$1 = G__16079;
continue;
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__16080_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__16080_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__16080_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__16081_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__16081_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__16081_SHARP_));
